...
class AuthenticationViewModel: ObservableObject {
    ...
    func createUser() async throws {
        do {
            ...
            await uploadUserData(uid: result.user.uid, username: username, email: email, profileImageUrl: profileImageUrl!)
    ...
    @MainActor
    func uploadUserData(uid: String, username: String, email: String, profileImageUrl: String) async {
